...
Button(root,text="*", width=5, height=1, font=("arial",25,"bold"), bd=1, fg="#fff",bg="#2a2d36", command=lambda: show("*")).place(x=430,y=100)
...
Button(root,text="0", width=11, height=1, font=("arial",25,"bold"), bd=1, fg="#fff",bg="#2a2d36",command=lambda: show("0")).place(x=10,y=500)

Button(root,text=".", width=5, height=1, font=("arial",25,"bold"), bd=1, fg="#fff",bg="#2a2d36", command=lambda: show(".")).place(x=290,y=500)
Button(root,text="=", width=5, height=3, font=("arial",25,"bold"), bd=1, fg="#fff",bg="#fe9037", command=lambda: calculate()).place(x=430,y=400)
